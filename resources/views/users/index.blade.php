    ...
    <table class="table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="col-actif">
                    <span style="color: {{ $u->is_active ? 'var(--vert-ok)' : 'var(--rouge-france)' }}; font-family:'VT323',monospace; font-size:20px;">
                        {{ $u->is_active ? 'Oui' : 'Non' }}
                    </span>
                </td>
                <td class="col-login" style="font-family:'VT323',monospace; font-size:16px; color:#888;">
...
<div id="confirm-dialog" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.5); z-index:999; align-items:center; justify-content:center;">
    <div style="background:var(--blanc); border-radius:var(--radius); padding:30px; max-width:440px; width:90%; border:2px solid var(--bleu-france);">
        <h3 style="font-family:'VT323',monospace; font-size:26px; color:var(--bleu-france); margin-bottom:16px;">
            <i class="fa-solid fa-triangle-exclamation" style="color:var(--rouge-france);"></i> <span id="confirm-title"></span>
        </h3>
        <p id="confirm-message" style="font-family:'Courier Prime',monospace; font-size:15px; margin-bottom:24px; line-height:1.5;"></p>
