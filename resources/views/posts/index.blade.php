...
@if($posts->count() > 0)
    <div class="post-grid">
        ...
        <a href="/posts/{{ $post->post_id }}" class="post-card" style="text-decoration:none; color:inherit;">
            ...
            @else
                <div class="post-card-img" style="display:flex; align-items:center; justify-content:center; font-family:'Inter',sans-serif; font-size:24px; color:#999;">Pas d'image</div>
            @endif
